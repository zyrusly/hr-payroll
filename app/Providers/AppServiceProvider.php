    ...
    public function boot(): void
    {
        View::composer('partials.template.sidebar', function ($view): void {
            ...
            $view->with('sidebarState', [
                ...
                'canBranchView' => $can('branch.view'),
                'canBranchCreate' => $can('branch.create'),
                'canBranchUpdate' => $can('branch.update'),
                'canBranchMenu' => $canAny(['branch.view', 'branch.create', 'branch.update', 'branch.delete']),
                'canScheduleView' => $can('schedule.view'),
                'canScheduleCreate' => $can('schedule.create'),
                'canScheduleUpdate' => $can('schedule.update'),
                'canScheduleMenu' => $canAny(['schedule.view', 'schedule.create', 'schedule.update', 'schedule.delete']),
