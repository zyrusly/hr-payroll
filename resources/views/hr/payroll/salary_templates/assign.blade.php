                ...
                <div class="content_wrapper content-padded">
                    <form method="POST" action="{{ route('payroll.salary-template-assignments.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group mb-3"><label>{{ __('Pay Frequency') }}</label><select name="pay_frequency" class="form-control"><option value="">{{ __('Use Template Frequency') }}</option><option value="monthly" {{ old('pay_frequency')==='monthly'?'selected':'' }}>{{ __('Monthly') }}</option><option value="weekly" {{ old('pay_frequency')==='weekly'?'selected':'' }}>{{ __('Weekly') }}</option><option value="semimonthly" {{ old('pay_frequency')==='semimonthly'?'selected':'' }}>{{ __('Semi-Monthly') }}</option></select></div>
